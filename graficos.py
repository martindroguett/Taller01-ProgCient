...
df = pd.read_csv("results/top_salidas.csv").head(20).sort_values("Grado_Salida")
...
df = pd.read_csv("results/top_entradas.csv").head(20).sort_values("Grado_Entrada")
...
for ax, csv, col, titulo in [(axes[0], "results/top_salidas.csv",  "Grado_Salida",  "Grado salida"),(axes[1], "results/top_entradas.csv", "Grado_Entrada", "Grado entrada"),]:
...
#top 20 pagerank
df = pd.read_csv("results/top_pagerank.csv").head(20).sort_values("PageRank_Score")
...
df_pr = pd.read_csv("results/top_pagerank.csv").head(200)
df_e  = pd.read_csv("results/top_entradas.csv")[["Id", "Grado_Entrada"]]
...
cats = pd.read_csv("results/top_pagerank.csv").head(100)["Categorias"].dropna()
